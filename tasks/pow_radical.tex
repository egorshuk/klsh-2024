\begin{enumerate}[resume*]
    ...
    \item Окружность $\omega$ проходит через вершины $A$ и $D$ равнобокой трапеции $ABCD$ и пересекает диагональ $BD$ и боковую сторону $CD$ в точках $P$ и $Q$ соответственно. Точки $P'$ и $Q'$ симметричны точкам $P$ и $Q$ относительно середин отрезков $BD$ и $CD$ соответственно. Докажите, что $B$, $C$, $P'$ и $Q'$ концикличны. \wishlisted
        ...
        \solution{
            ...
            Уравнение \labelcref{eq:37.2} верно, т.к. $\omega, B, C$ -- все эти объекты симметричны относительно серединного перпендикуляра к $AD$.
        }
    ...
    \item Чевианы $AD$, $BE$ и $CF$ треугольника $ABC$ конкурентны. Прямая $EF$ пересекает окружность $(ABC)$ в точках $P$ и $Q$. Докажите, что $P$, $Q$, $D$ и середина отрезка $BC$ концикличны.
        ...
        \solution{
            ...
            Хочется еще отвемить, что из уравнения \labelcref{eq:42.4} следует, что 
            \[
